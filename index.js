    ...
    if (message.substring(0,6) == '!mashu') {
        ...
        if (cmd[0] == 'al') {
            ...
            for (let i = 0; i< Object.keys(servants).length; i++) {
                if (cmd[1] + ' ' + cmd[2] == servants[i].fname || cmd[1] + ' ' + cmd[2] == servants[i].nick) {
                    bot.sendMessage({
                        to: channelID,
        ...
        if (flag == 0) {
            for (let i = 0; i < Object.keys(servants).length; i++) {
                if (cmd[1] == servants[i].fname || cmd[1] == servants[i].id ||  cmd[1] == servants[i].nick) {
                    bot.sendMessage({
                        to: channelID,
                        message: 'Senpai, this is the servant you requested: \n'+'``` ID: ' +servants[i].id+
                                '\n Name: ' +servants[i].fname+ ' '+servants[i].lname+
            ...
            for (let i = 0; i< Object.keys(skills).length; i++) {    
                if (cmd[1] + ' ' + cmd[2] + ' ' + cmd[3] == skills[i].fname || cmd[1] + ' ' + cmd[2] + ' ' + cmd[3] == skills[i].nick || cmd[1] + ' ' + cmd[2] == skills[i].fname || cmd[1] + ' ' + cmd[2] == skills[i].nick) {
            ...
            if (flag == 0) {
                for(let i = 0; i <Object.keys(skills).length;i++) {
                    if (cmd[1] == skills[i].fname || cmd[1] == skills[i].id ||  cmd[1] == skills[i].nick){
                        if (skills[i].hasOwnProperty('skill1a')) {
                            // has upgraded skill 1
                            if (skills[i].hasOwnProperty('skill2a')) {
                                // has upgraded skill 2
